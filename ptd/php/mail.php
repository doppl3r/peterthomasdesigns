...
$mail->addAddress('pmoose@peterthomasdesigns.com');
//$mail->addAddress($_REQUEST['email'], $_REQUEST['name']);
//Set the subject line
$mail->Subject = 'Peter Thomas Designs Contact Notification';
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
$message =  '<p>'.$_REQUEST['name'].' would like to know more about Peter Thomas Designs</p>'.
            '<div style="border: 1px dashed #00a8d8; border-radius: 5px; padding: 0px 24px 24px;">'.
